...
<!-- Admin interface -->
    ...
    <div class="grid justify-items-center p-6 shadow-lg rounded-lg bg-gray-100 text-gray-700 mx-auto my-auto w-8/12 h-full">
        <h2 class="text-xl text-cyan-900 font-bold leading-tight tracking-tight md:text-2xl dark:text-white space-y-4 md:space-y-6 sm:pb-8">
            Admin interface
        </h2>
