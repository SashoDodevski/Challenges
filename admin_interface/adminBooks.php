...
<!-- Create Book form / Modal - shows on Add new book button -->
    <div class="w-4/12 p-6 space-y-4 md:space-y-6 sm:p-8 bg-gray-50 text-blue-900 shadow-lg rounded-lg mx-auto hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 flex top-positioning-136 mb-10" id="divMain">
...
<div class="content min-h-screen flex negative-top-positioning-68">
    ...
    <div class="relative text-ellipsis overflow-x-hidden ... shadow-md sm:rounded-lg w-10/12 mx-auto mb-10 bg-gray-100 border top-positioning-136" id="divTable">
