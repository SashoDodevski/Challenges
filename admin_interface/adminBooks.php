        ...
        <div class="w-10/12 mx-auto">
            ...
            <input type="hidden" name="action" value="create">
                ...
                <div>
                    ...
                    <select type="text" name="bookCategory" id="bookCategory" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-cyan-500 dark:focus:border-cyan-500" placeholder="Book category" required="">
...
<div class="content min-h-screen flex negative-top-positioning-68">
    ...
    <div class="relative text-ellipsis overflow-x-hidden ... shadow-md sm:rounded-lg w-10/12 mx-auto mb-12 bg-gray-100 border top-positioning-170" id="divTable">
        <div class="flex justify-between dark:bg-gray-500">
            <p class="m-3 text-3xl dark:text-white">Books</p>
