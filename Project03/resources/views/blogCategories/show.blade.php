    ...
    <div class="basis-2/3 text-left">
        ...
        <div class="flex flex-row justify-around">
            <div class="text-start">
                <a type="button" href="{{ route('blogCategories.index') }}" class="w-32 text-center p-1.5 pl-5 pr-5 text-sm transition-colors duration-700 transform bg-cyan-600 hover:bg-cyan-500 text-gray-100 rounded-lg focus:border-4 border-cyan-300 my-5 ml-0 mr-auto">Back</a>
            </div>
            <div class="text-start">
                <a type="button" href="{{ route('blogCategories.edit', $blogCategory)}}" class="w-32 text-center text-sm p-1.5 pl-5 pr-5 transition-colors duration-700 transform bg-amber-600 hover:bg-amber-500 text-gray-100 rounded-lg focus:border-2 border-amber-300 mt-5 ml-0 mr-auto">Edit</a>
            </div>
            <div class="text-start">
        ...
        <div class="flex flex-col w-full mx-auto my-5 border rounded-lg p-5 bg-gray-50">
            <div class="flex flex-col p-4 leading-normal text-start w-full bg-gray-50">
                <h5 class="mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white text-center">{{ $blogCategory->category}}</h5>
            </div>
        </div>
    </div>
