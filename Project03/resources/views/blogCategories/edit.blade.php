...
<div class="flex flex-row justify-center grow bg-gray-50">
    ...
    <h1 class="mt-10 mb-2 text-2xl text-black">Edit blog category</h1>

        <div class="md:w-2/3 lg:w-2/4 mx-auto text-left bg-gray-50 p-8 border rounded-lg">
            <form class="my-5" action="{{ route('blogCategories.update', $blogCategory) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
