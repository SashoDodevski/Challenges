    ...
    <div class="basis-2/3 text-left">
        ...
        <div class="flex flex-row justify-around">
            <div class="text-start">
                <a type="button" href="{{ route('blogs.index') }}" class="w-32 text-center p-1.5 pl-5 pr-5 text-sm transition-colors duration-700 transform bg-cyan-600 hover:bg-cyan-500 text-gray-100 rounded-lg focus:border-4 border-cyan-300 my-5 ml-0 mr-auto">Back</a>
            </div>
            <div class="text-start">
                <a type="button" href="{{ route('blogs.edit', $blog) }}" class="w-32 text-center text-sm p-1.5 pl-5 pr-5 transition-colors duration-700 transform bg-amber-600 hover:bg-amber-500 text-gray-100 rounded-lg focus:border-4 border-amber-300 mt-5 ml-0 mr-auto">Edit</a>
            </div>
            <div class="text-start">
        ...
        <div class="flex flex-col shadow-lg mx-auto my-5 border rounded-lg w-full bg-gray-50 p-2 overflow-hidden overflow-y-auto">
            <div class="bg-gray-50 w-60 mx-auto">
                <img class="object-cover w-full md:rounded-lg" src="{{ asset('storage/'.$blog->image) }}" alt="">
            </div>
            <div class="flex flex-col p-4 leading-normal text-start w-full bg-gray-50">
                ...
                <p class="mb-3 text-xs text-gray-700 dark:text-gray-400"><span class="font-semibold">Content:</span> <br>{{ $blog->text }}</p>
            </div>
        </div>
    </div>
