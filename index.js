      ...
      itemsData.data.forEach((element) => {
        let card = $(`
                        <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                            <a><img class="rounded-t-lg mx-auto p-5 max-h-96" src="${element.book_image}" alt=""/></a>
                            <div class="p-5">
                              <a><h5 class="mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white">${element.book_title}</h5></a>
