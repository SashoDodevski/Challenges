...
?>
        ...
        <h2 class="text-xl text-blue-900 font-bold leading-tight tracking-tight md:text-2xl dark:text-white space-y-4 md:space-y-6 sm:pb-8 ">
            ...
            <a type="button" class="text-white bg-blue-900 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-900 dark:hover:bg-blue-800 dark:focus:ring-blue-800 mb-6 sm:w-6/12" href="./adminBooks.php">Books</a>
