...
?>
    ...
    <!-- Register Form-->
    <section class="bg-gray-50 dark:bg-gray-900 pt-14 pb-4">
            ...
            <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8 text-cyan-900">
                    ...
                    <form class="space-y-4 md:space-y-6" action="./authentication/userRegistration.php" method="POST">
                        ...
                        <button type="submit" class="w-full text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-900 dark:hover:bg-blue-800 dark:focus:ring-blue-800">Register</button>
