...
<body>
    ...
    <div class="container flex flex-wrap items-center justify-between mx-auto">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg w-10/12 mx-auto mb-10 mt-24">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg w-10/12 mx-auto mb-10 mt-10">
