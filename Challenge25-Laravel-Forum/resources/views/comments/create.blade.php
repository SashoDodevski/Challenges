    ...
    <div class="w-2/3 my-20">
        <div class="border rounded-lg p-5 bg-gray-50">
            <form action="{{ route('comments.store', $forum) }}" method="POST">
                ...
                <button type="submit" class="text-xs p-1.5 pl-5 pr-5 transition-colors duration-700 transform bg-cyan-600 hover:bg-cyan-500 text-gray-100 rounded-lg focus:border-2 border-cyan-300 ml-0 mr-auto">Submit</button>
